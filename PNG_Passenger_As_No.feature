@smoke
Feature: Validate the Functionality of File A Complaint by selecting for Penang International Airport
Scenario: Verify that user should File A Complaint
   ...
   Then Click on the Feedback Icon in the my profile page
    ...
    And click on Touch point for Penang International Airport  
